    ...
    return (
      <Card className="p-10 rounded-2xl shadow-xl w-full max-w-3xl mx-auto">
        <h2 className="text-2xl font-semibold text-white flex items-center gap-2 mb-6">
          Setup your MOCA Gaming Passport
        </h2>
        ...
        {step === 1 && (
          <>
            <p className="text-zinc-400 mb-4">
              Connect at least <span className="text-foreground">one platform</span>{" "}
          ...
          <div className=" p-6 rounded-xl border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1">
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Connected</span>
              ...
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Game</span>
                <span className="text-white font-semibold ">
                  {form.game.toUpperCase()}
                </span>
              </div>
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Rank</span>
                <span className="text-white font-semibold">{form.rank}</span>
              </div>
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Name</span>
                <span className="text-white font-semibold">{form.name}</span>
              </div>
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Age</span>
                <span className="text-white font-semibold">{form.age}</span>
              </div>
  
              <div className="bg-card rounded-lg p-4 flex flex-col">
                <span className="text-sm text-muted-foreground mb-2 font-medium block">Country</span>
